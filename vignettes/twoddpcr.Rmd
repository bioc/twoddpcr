...
If you have run your own ddPCR experiments that have produced a _QuantaSoft_ 
Plate (`.qlp`) file, then the raw droplet amplitudes can be extracted for use 
with the `twoddpcr` package. To do this:
